...
{({ getInputProps, suggestions, getSuggestionItemProps, loading }) => (
         ...
         <input style={{width:'100%'}} {...getInputProps({ placeholder: "Enter area, street name..." })} />
         {loading ? 
         <div className='loading'>
  <div className="loadingio-spinner-rolling-1s0xdpdttrj"><div className="ldio-a8ab71rjvvs">
<div></div>
</div></div> </div>: <img className="left" src="/search.svg"/>}
         </div>
...
<div className="content">
  <div className="s">  {suggestion.description}</div>
              ...
              <div onClick={()=>{CurrentLocation()}} className="suggestion">
              <img src="/gps.svg"/>
              <div className="content">
...
{name.length !==0?<a href="/profile">{name}</a>:
